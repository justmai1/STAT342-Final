...
vac_df %>% 
  ...
  title("BNT162b2 vs Placebo Infection Rate Comparison")
```
...
```{r, echo=F, label="taylor_plot", warning=F, fig.height=4, fig.width=7, fig.align='center'}
